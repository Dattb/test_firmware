...
proj/mcu_spec/%.o: ../proj/mcu_spec/%.S
	...
	tc32-elf-gcc -Xassembler"C:\Users\Dat UTC\Documents\Rang_Dong\CODE_LIGHT_SENSOR\firmware" -DMCU_STARTUP_8267 -D__LOAD_RAM_SIZE__=0x12 -D__PROJECT_8267_MASTER_KMA_DONGLE__=1 -DCHIP_TYPE=CHIP_TYPE_8269 -c -o"$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
