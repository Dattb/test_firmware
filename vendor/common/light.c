...
/*
 * RD_EDIT: sua ham nay de led nhay dung theo y minh
 */
...
//	    gpio_write(gpio, 0);  // TODO: nen sua cho nay de xem lai phan led bi flash cho gpio =1;
...
{
	light_ev_with_sleep(3, 200*1000);	//1Hz shine for  8 second
}
#endif
