...
#define LPN_POLL_TIMEOUT_100MS      (100*10) // unit: 100ms, 0x0A~0x34BBFF
#define FRI_POLL_INTERVAL_MS        (friend_poll)	// auto send poll interval
/*
 * RD_EDIT: cho chinh sua cac thong so LPN
 */
#define FRI_REQ_TIMEOUT_MS          (3000)  // must larger than 1100ms
...
#define LPN_WORKING_TIMEOUT_MS   	        (80*1000)   // Prevent abnormal working time.
